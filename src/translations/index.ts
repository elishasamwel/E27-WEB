...
export const translations: Record<Language, TranslationSchema> = {
  en: {
    ...
    howItWorks: {
      title: 'How E27 Works',
      subtitle: 'From application to completion in 4 easy, transparent steps.',
      step1Title: 'Choose Service',
      step1Desc: 'Browse our catalog and select the government portal or digital solution you need.',
      step2Title: 'Submit Details (by contacting us)',
      step2Desc: 'Contact us directly via WhatsApp or phone with your information and documents — no form filling required.',
      step3Title: 'Review (by contacting us)',
      step3Desc: 'We review and verify your details together via direct consultation before lodging with official systems.',
      step4Title: 'Get Results',
      step4Desc: 'Receive your processed certificate, TIN, registration, or completed digital project directly.',
    },
  },
  ...
  sw: {
    ...
    howItWorks: {
      title: 'Jinsi E27 Inavyofanya Kazi',
      subtitle: 'Kuanzia maombi hadi kukamilika katika hatua 4 rahisi na wazi.',
      step1Title: 'Chagua Huduma',
      step1Desc: 'Pitia orodha yetu na uchague huduma ya kiserikali au suluhisho la kidijitali unalohitaji.',
      step2Title: 'Wasilisha Taarifa (kwa kuwasiliana nasi)',
      step2Desc: 'Wasiliana nasi moja kwa moja kupitia WhatsApp au simu ukiwa na taarifa na nyaraka zako — hakuna kujaza fomu mtandaoni.',
      step3Title: 'Mapitio (kwa kuwasiliana nasi)',
      step3Desc: 'Tunapitia na kuthibitisha taarifa zako kwa mashauriano ya moja kwa moja kabla ya kuziwasilisha kwenye mifumo rasmi.',
      step4Title: 'Pata Matokeo',
      step4Desc: 'Pokea cheti chako, namba ya TIN, usajili au huduma ya kidijitali iliyokamilika moja kwa moja.',
    },
  },
  ...
  zh: {
    ...
    howItWorks: {
      title: 'E27 服务流程',
      subtitle: '从需求到交付，4个简易透明的步骤。',
      step1Title: '选择服务',
      step1Desc: '浏览我们的服务目录，选择您所需的政府门户或数字化解决方案。',
      step2Title: '提交资料（联系我们）',
      step2Desc: '直接通过WhatsApp或电话联系我们提供所需信息与文件——无需在线填写复杂表单。',
      step3Title: '确认审核（联系我们）',
      step3Desc: '我们通过直接沟通与您核实所有信息与文件，确保在正式递交前准确无误。',
      step4Title: '获取结果',
      step4Desc: '直接获取处理完成的官方证书、税号TIN或交付的数字化项目。',
    },
  },
  ...
  fr: {
    ...
    howItWorks: {
      title: 'Comment fonctionne E27',
      subtitle: 'De la demande à la finalisation en 4 étapes simples et transparentes.',
      step1Title: 'Choisir un service',
      step1Desc: 'Parcourez notre catalogue et sélectionnez le portail ou la solution numérique dont vous avez besoin.',
      step2Title: 'Soumettre les informations (en nous contactant)',
      step2Desc: 'Contactez-nous directement par WhatsApp ou téléphone avec vos documents — aucun formulaire à remplir.',
      step3Title: 'Vérification (en nous contactant)',
      step3Desc: 'Nous vérifions vos documents ensemble par consultation directe avant tout traitement officiel.',
      step4Title: 'Obtenir les résultats',
      step4Desc: 'Recevez directement votre certificat, TIN ou solution numérique finalisée.',
    },
  },
  ...
  de: {
    ...
    howItWorks: {
      title: 'Wie E27 funktioniert',
      subtitle: 'Vom Antrag bis zum Ergebnis in 4 einfachen, transparenten Schritten.',
      step1Title: 'Dienstleistung wählen',
      step1Desc: 'Durchsuchen Sie unseren Katalog und wählen Sie den gewünschten Service oder die digitale Lösung.',
      step2Title: 'Details übermitteln (durch Kontaktaufnahme)',
      step2Desc: 'Kontaktieren Sie uns direkt per WhatsApp oder Anruf — kein Ausfüllen von Formularen erforderlich.',
      step3Title: 'Prüfung (durch Kontaktaufnahme)',
      step3Desc: 'Wir prüfen und bestätigen Ihre Angaben gemeinsam im direkten Kontakt vor der Einreichung.',
      step4Title: 'Ergebnisse erhalten',
      step4Desc: 'Erhalten Sie Ihre bearbeiteten Zertifikate, TIN oder fertigen digitalen Ergebnisse direkt.',
    },
  },
};
